    ...
    <AuthenticatedLayout>
        <section class="flex flex-col gap-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-semibold">Ask a Question</h1>
                    <p class="mt-2 text-sm text-slate-400">Share context, include links, and add screenshots if helpful.</p>
                </div>
                <Link
            ...
            <form class="flex flex-col gap-6" @submit.prevent="submit">
                ...
                <div class="flex items-center gap-3">
                    <PrimaryButton :disabled="form.processing">Publish Question</PrimaryButton>
                    <Link
                        :href="route('questions.index')"
